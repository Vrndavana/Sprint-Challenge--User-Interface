...
Semantic HTML is the brackets used around text on a page to assign desired sections into groups you can effect
...
align-items: center moves the content along the Y axis 

5. Explain why git is valuable to a team of developers.
git is valuable to developers by letting people work on 1 project with different copys that they can merg together all while working.
